...
export const LOCAL_ORDERS = [
  {
    ...
    priority: false,
    estimatedDelivery: "2025-07-03T18:30:00Z",
    cart: [{ pizzaId: 1, name: "Margherita", quantity: 2, totalPrice: 24 }],
    status: "preparing",
  },
  {
    id: 2,
    ...
    priority: true,
    estimatedDelivery: "2025-07-03T18:45:00Z",
    cart: [{ pizzaId: 2, name: "Capricciosa", quantity: 1, totalPrice: 14 }],
    status: "delivered",
  },
];
